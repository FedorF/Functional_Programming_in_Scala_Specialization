...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    ...
    def maxRetweet(tweetA: Tweet, tweetB: Tweet): Tweet ={
      if (tweetA.retweets >= tweetB.retweets) tweetA
      else tweetB
    }
...
/**
  ...
  *
  * From the union of those two TweetSets, produce trending,
  * an instance of class TweetList representing a sequence of
  * tweets ordered by their number of retweets:
  *
  */
